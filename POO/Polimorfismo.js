...
function imprimir(tipo) {//PODEMOS PASARLE UN TIPO DE LA CLASE PADRE O HIJA Y DEPENDIENDO DE ESO, SE LLAMA EL METODO DE ESA CLASE.
   return  tipo.obtenerDetalle();
}
